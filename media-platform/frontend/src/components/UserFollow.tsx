...
const UserFollow: React.FC<UserFollowProps> = ({ 
  ...
  const handleUserFollow = async (targetUserId: number, isCurrentlyFollowing: boolean) => {
    ...
    <div style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{
        ...
        {showActions && currentUserId && currentUserId !== userId && (
          ...
          >
            {followLoading ? '処理中...' : (
              followStats.is_following ? '🚫 アンフォロー' : '➕ フォロー'
            )}
          </button>
        )}
      </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  padding: '0.75rem',
                  border: 'none',
                  backgroundColor: activeTab === 'followers' ? '#3b82f6' : 'transparent',
              ...
              <button
                ...
                style={{
                  ...
                  padding: '0.75rem',
                  border: 'none',
                  backgroundColor: activeTab === 'following' ? '#3b82f6' : 'transparent',
            ...
            <div style={{
              ...
              {loading ? (
                ...
                <div>
                  {(activeTab === 'followers' ? followers : following).map((follow) => {
                    const user = activeTab === 'followers' ? follow.follower : follow.following;
                    if (!user) return null;

                    return (
                      <div key={follow.id} style={{
                        display: 'flex',
                        alignItems: 'center',
                        padding: '0.75rem',
                      ...
                      onMouseLeave={(e) => {
                        ...
                        {currentUserId && currentUserId !== user.id && (
                          <FollowButton
                            ...
                            onFollowChange={() => handleUserFollow(user.id, false)}
                          />
                        )}
                      </div>
                    );
