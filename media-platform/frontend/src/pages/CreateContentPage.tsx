      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            現在のステータス: {formData.status}<br/>
            タイトル: {formData.title || '(空)'}<br/>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                <button
                  ...
                  style={{
                    ...
                    border: formData.status === 'draft' ? '2px solid #3b82f6' : '1px solid #d1d5db',
                    borderRadius: '6px',
                    backgroundColor: formData.status === 'draft' ? '#dbeafe' : 'white',
                ...
                <button
                  ...
                  style={{
                    padding: '0.75rem 1.5rem',
                    border: formData.status === 'published' ? '2px solid #059669' : '1px solid #d1d5db',
                    borderRadius: '6px',
                    backgroundColor: formData.status === 'published' ? '#dcfce7' : 'white',
                    color: formData.status === 'published' ? '#166534' : '#374151',
                    cursor: 'pointer',
                    fontSize: '0.875rem',
              ...
              <div style={{
                ...
                現在選択中: {formData.status === 'published' ? '今すぐ公開' : '下書き保存'}
              </div>
            </div>
            ...
            <div style={{
              ...
              >
                {loading ? '作成中...' : 
                  formData.status === 'published' ? '✨ 公開する' : '📝 下書き保存'
                }
              </button>
            </div>
          </form>
