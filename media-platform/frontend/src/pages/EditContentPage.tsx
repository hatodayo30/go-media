...
const EditContentPage: React.FC = () => {
  ...
  const fetchContentAndCategories = async () => {
    try {
      ...
      const contentData = contentRes.data?.content || contentRes.content || contentRes;
      const categoriesData = categoriesRes.data?.categories || categoriesRes.categories || categoriesRes || [];
      ...
      <div style={{
        ...
        <form onSubmit={(e) => handleSubmit(e, false)}>
          ...
          <div style={{ 
            ...
            <span style={{
              backgroundColor: originalContent?.status === 'published' ? '#dcfce7' : '#fef3c7',
              color: originalContent?.status === 'published' ? '#15803d' : '#92400e',
